...
Plugin Name: WordPress Proper Photo Gallery
Plugin URI: http://www.discoverwebdev.ca/plugins/wordpress-proper-photo-gallery
Description: Easy to use Photo Gallery.   
Author: Nathan Bowman
Author URI: http://www.discoverwebdev.ca
Version: 1.0

	Copyright: © 2013 Nathan Bowman (email : nathan@linkedinvancouver.com)
...
function create_post_type_gallery() {
	register_post_type( 'Gallery', 
		array(
			...
			'description' => __( 'A Gallery is a.' ),
			'menu_position' => 20, //increment by 5 per menu position
			//'menu_icon' => get_stylesheet_directory_uri() . '/images/Galleries.png',
			'taxonomies' => array('category'), //Allows for categories within Gallery Post Type
